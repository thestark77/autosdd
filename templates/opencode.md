...
- **mem_search**: Before starting work, search for relevant past decisions, bugs, patterns — supports cross-language semantic matching (e.g., "adoption wait" finds "tiempo de espera en adopciones")
